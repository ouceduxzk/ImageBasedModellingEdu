...
int main(int argc, char* argv[])
{
     ...
     * TODO 对A矩阵进行赋值
     */
    math::Vec4d row1 = static_cast<double>(p1[0]) * P1.row(2) - P1.row(0);
    math::Vec4d row2 = static_cast<double>(p1[1]) * P1.row(2) - P1.row(1);
    math::Vec4d row3 = static_cast<double>(p2[0]) * P2.row(2) - P2.row(0);
    math::Vec4d row4 = static_cast<double>(p2[1]) * P2.row(2) - P2.row(1);
